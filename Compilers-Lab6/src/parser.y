...
PrimaryExp
    ...
    | ID LPAREN FuncRParams RPAREN {
        ...
        SymbolEntry *se = new TemporarySymbolEntry(retType, SymbolTable::getLabel());
        $$ = new CallExpr(se, t, $3);
        delete []$1;
    }
    | ID LPAREN RPAREN {
...
ConstDef
    ...
    ID ASSIGN ConstExp {
        ...
        if(!SymbolTable::identifiers->install($1, se)){
...
FuncDef
    ...
    Type ID {
        ...
        se->setType($1);
        if(!SymbolTable::identifiers->install($2, se)){
